...
* **Proposals (DRAFT)** — [RFC-001: openBIM conformance corpus](docs/proposals/RFC-001-conformance-corpus.md) · [ADR-001: repo boundaries](docs/proposals/ADR-001-repo-boundaries.md) · [Licensing recommendation](docs/proposals/LICENSING.md) · [license scaffold](docs/proposals/licensing-scaffold/README.md) · discussion in [Issue #7](https://github.com/MosslandOpenDevs/AEC-Fundamentals/issues/7)
* **Conformance PoC (DRAFT)** — [AECF-HVAC-Semantics-0.1](validator/README.md): a real IFC 4.3 + IDS 1.0 pass/fail corpus validated in CI (`mvp0-conformance`)

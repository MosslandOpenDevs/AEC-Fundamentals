...
Simply put, it refers to the process of planning, designing, and constructing a building or other structure and its outcome. However, architecture is not just referring to this physical construction process, but **comprehensive art** that contains people's convenience and safety, the culture and history of the time, etc.
...
The design work and construction process are performed in the following order.

1. **Pre-design / Programming**: Plan design tasks required by the owner in advance because they are necessary for building design orders such as size review, field survey, and design guidelines. 
2. **Schematic Design(SD)**: The plan is approved after reviewing the design concept and basic system of related fields.
3. **Design Development(DD)**: Various reviews are conducted to minimize the possibility of changes in the CD and to specify the contents of the SD. The plan is approved by the owner at this stage.
4. **Construction Documents(CD)**: Create plans (including specifications) with construction in mind.
5. **Construction**  
6. **Post-Occupancy Evaluation(POE)**: This is the stage of evaluating the complecated building after using it.
...
- ISOVER 건축용어사전, https://www.isover.co.kr/geonchugyongeosajeon
- 마루건축, 서양건축, https://mahru.co.kr/index.php?mid=Archi&category=26858
- 건축의 역사: 서양건축(고대, 중세, 현대), https://hoibin.tistory.com/entry/%EA%B1%B4%EC%B6%95%EC%9D%98-%EC%97%AD%EC%82%AC-%EC%84%9C%EC%96%91%EA%B1%B4%EC%B6%95-%EA%B3%A0%EB%8C%80%EC%A4%91%EC%84%B8%ED%98%84%EB%8C%80
